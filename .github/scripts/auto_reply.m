...
function prompt = buildSystemPrompt(mainReadme, projectDesc, wikiContent)
    prompt = sprintf([ ...
        ...
        'Challenge Projects program. Politely decline unrelated questions.\n' ...
        ...
        '5. Keep responses SHORT and to the point — ideally under 150 words. ' ...
        'Avoid lengthy explanations, bullet-heavy lists, or restating the question. ' ...
